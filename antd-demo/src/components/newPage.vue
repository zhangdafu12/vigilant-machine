<template>
  <div class="hello-cont">
    ...
    <div class="collec-cont" v-if="hidden">
      <div class="coll_cont">
        <p>收藏</p>
        <img src="../assets/images/remove.png" @click="onHidden">
      </div>
      <img class="collec-imgs" src="../assets/images/surmon-1.jpg">
      <input type="text" placeholder="文字描述" class="describe"></input>
      <p class="task-p">选择任务管理器</p>
      <div class="task-manager">
        <div class="task" @click="onHidden1">
    ...
    <div class="collec-cont1" v-if="hidden1">
      <div class="coll_cont">
        <p>收藏</p>
        <img src="../assets/images/remove.png" @click="onHidden2">
      </div>
      <form>
        <label>时间</label>
        <input type="text" class="time"><br>
        <label>地点</label>
        <input type="text" class="site"><br>
        <label>客户</label>
        <input type="text" class="client"><br>
        <label>销售</label>
        <input type="text" class="sell"><br>
        <label>设计</label>
        <input type="text" class="design"/><br>
        <label>添加标签</label><br>
        <el-dropdown>
          <el-button type="primary">
            风格<i class="el-icon-arrow-down el-icon--center"></i>
          </el-button>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>风格一</el-dropdown-item>
            <el-dropdown-item>风格二</el-dropdown-item>
            <el-dropdown-item>风格三</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
        <el-dropdown>
          <el-button type="primary">
            色系<i class="el-icon-arrow-down el-icon--center"></i>
          </el-button>
          <el-dropdown-menu slot="dropdown">
        ...
        <label>自定义标签</label><br>
        <button class="but manner">风格</button>
        <button class="but colour">色系</button><br>
        <button class="but certain">确 定</button>
    ...
    <div class="pattern">
      <div class="lump video">
        <img src="../assets/images/video.png">视频模式
      </div>
      <div class="lump print">
        <img src="../assets/images/print.png">图片模式
      </div>
    </div>
    <div class="collect" @click="onHidden">
    ...
    <div class="swiper-box">
      ...
      <swiper :options="swiperOptionTop" class="gallery-top" ref="swiperTop">
        <swiper-slide class="slide-1">
          <img src="../assets/images/surmon-1.jpg">
        </swiper-slide>
        <swiper-slide class="slide-2">
          <img src="../assets/images/surmon-2.jpg">
        </swiper-slide>
        <swiper-slide class="slide-3">
          <img src="../assets/images/surmon-3.jpeg">
        </swiper-slide>
        <swiper-slide class="slide-4">
          <img src="../assets/images/surmon-4.jpg">
        </swiper-slide>
        <swiper-slide class="slide-5">
          <img src="../assets/images/surmon-5.jpg">
        </swiper-slide>
      ...
      <!-- swiper2 Thumbs -->
      <div class="area">
        <div class="lump usher">酒店迎宾区</div>
        <div class="lump sweet">甜品区</div>
        <div class="lump runway">T台区</div>
        <div class="lump editor">主舞台区</div>
      </div>
      <swiper :options="swiperOptionThumbs" class="gallery-thumbs" ref="swiperThumbs">
        ...
        <div class="position swiper-button-next1" slot="button-next"></div>
        <div class="position swiper-button-prev1" slot="button-prev"></div>
      </swiper>
