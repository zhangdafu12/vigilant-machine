<template>
  <div class="staff">
      ...
      <fieldset>
        ...
        <table>
          <tbody>
            ...
            <td>{{p.post}}</td>
            <td>{{p.phone}}</td>
            <td><button class="btn sonbtn" @click="onDelete(index,'alone')">删除员工</button></td>
          </tr>
          </tbody>
        </table>
      </fieldset>
    ...
    <div class="content1" v-if="addshow">
      <div class="add_cont">
        <p>添加员工</p>
        <img src="../../assets/images/remove.png" @click="onAdd">
      </div>
      <div class="add_in">
        <label>姓&#8195;名</label>
    ...
    <div class="content1" v-if="delshow">
      <div class="add_cont">
        <p>删除员工</p>
        <img src="../../assets/images/remove.png" @click="onDelete">
      </div>
      <div class="add_in">
        <div class="del_box">
